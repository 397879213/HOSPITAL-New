...
public class ClientWiseCpt {
    ...
    public String getClientCptPrice() {
        return clientCptPrice;
    }

    public void setClientCptPrice(String clientCptPrice) {
        this.clientCptPrice = clientCptPrice;
    }
