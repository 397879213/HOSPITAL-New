...
public class CPT implements java.io.Serializable {
    ...
    public String onlyOPDVisit = "";
    public String specimenId = "";
    public String specimenDescription = "";
    public String clientName = "";
    public String orderLevelInvoice = "";
    public String price = "";
    ...
    private String opdFileRequired = "";
    //SETUP TABLES
    ...
    public String getOpdFileRequired() {
        return opdFileRequired;
    }

    public void setOpdFileRequired(String opdFileRequired) {
        this.opdFileRequired = opdFileRequired;
    }
    ...
    public String getOnlyOPDVisit() {
        return onlyOPDVisit;
    }

    public void setOnlyOPDVisit(String onlyOPDVisit) {
        this.onlyOPDVisit = onlyOPDVisit;
    }
    ...
    public String getOrderLevelInvoice() {
        return orderLevelInvoice;
    }

    public void setOrderLevelInvoice(String orderLevelInvoice) {
        this.orderLevelInvoice = orderLevelInvoice;
    }
    ...
    public String getReportTimingId() {
        return reportTimingId;
    }

    public void setReportTimingId(String reportTimingId) {
        this.reportTimingId = reportTimingId;
    }

    public String getDefaultCPTId() {
        return defaultCPTId;
    }

    public void setDefaultCPTId(String defaultCPTId) {
        this.defaultCPTId = defaultCPTId;
    }

    public String getLastCPTId() {
        return lastCPTId;
    }

    public void setLastCPTId(String lastCPTId) {
        this.lastCPTId = lastCPTId;
    }

    public String getDefaultCPTDescription() {
        return defaultCPTDescription;
    }

    public void setDefaultCPTDescription(String defaultCPTDescription) {
        this.defaultCPTDescription = defaultCPTDescription;
    }
