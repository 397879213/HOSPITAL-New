...
public class StudyData implements Serializable {
    ...
    private String wardRegistrarNo = "";
    private String otherInfo = "    ";
//PATHOLOGY PARAMTERS 

    private String macroAppearance = "";
    private String microAppearance = "";
    ...
    private String cytoHistoNo = "";
    private String cytoHistoCategory = "";
    private String cytoHistoType = "";
    private String cytoHistoSpecimenAdequacy = "";
    private String cytoHistoDescription = "";
    ...
    private String performingPhysicianContractId = "726";

    private String result = "";
    private String criticalResult = "N";

    private String simpleText = "";
    private String lisEntrycomments = "";
    ...
    private String appointmentGivenBy = "";
    private String appointmentGivenDate = "";
    ...
    private String clientPatientContactNo = "";
    private String clientPatientEmail = "";
...
//private String emailRemarks = "";
    ...
    public String getCytoHistoNo() {
        return cytoHistoNo;
    }

    public void setCytoHistoNo(String cytoHistoNo) {
        this.cytoHistoNo = cytoHistoNo;
    }

    public String getCytoHistoCategory() {
        return cytoHistoCategory;
    }

    public void setCytoHistoCategory(String cytoHistoCategory) {
        this.cytoHistoCategory = cytoHistoCategory;
    }

    public String getCytoHistoType() {
        return cytoHistoType;
    }

    public void setCytoHistoType(String cytoHistoType) {
        this.cytoHistoType = cytoHistoType;
    }

    public String getCytoHistoSpecimenAdequacy() {
        return cytoHistoSpecimenAdequacy;
    }

    public void setCytoHistoSpecimenAdequacy(String cytoHistoSpecimenAdequacy) {
        this.cytoHistoSpecimenAdequacy = cytoHistoSpecimenAdequacy;
    }

    public String getCytoHistoDescription() {
        return cytoHistoDescription;
    }

    public void setCytoHistoDescription(String cytoHistoDescription) {
        this.cytoHistoDescription = cytoHistoDescription;
    }

    public String getMacroAppearance() {
        return macroAppearance;
    }

    public void setMacroAppearance(String macroAppearance) {
        this.macroAppearance = macroAppearance;
    }

    public String getMicroAppearance() {
        return microAppearance;
    }

    public void setMicroAppearance(String microAppearance) {
        this.microAppearance = microAppearance;
    }
    ...
    public String getWardRegistrarNo() {
        return wardRegistrarNo;
    }

    public void setWardRegistrarNo(String wardRegistrarNo) {
        this.wardRegistrarNo = wardRegistrarNo;
    }
    ...
    public String getPerformingPhysicianContractId() {
        return performingPhysicianContractId;
    }

    public void setPerformingPhysicianContractId(String performingPhysicianContractId) {
        this.performingPhysicianContractId = performingPhysicianContractId;
    }
    ...
    public String getLisEntrycomments() {
        return lisEntrycomments;
    }

    public void setLisEntrycomments(String lisEntrycomments) {
        this.lisEntrycomments = lisEntrycomments;
    }
    ...
    public String getPerformingTechnologist() {
        return performingTechnologist;
    }

    public void setPerformingTechnologist(String performingTechnologist) {
        this.performingTechnologist = performingTechnologist;
    }
    ...
    public void setSectionCounter(String sectionCounter) {
    ...
    public String getAppointmentGivenBy() {
        return appointmentGivenBy;
    }

    public void setAppointmentGivenBy(String appointmentGivenBy) {
        this.appointmentGivenBy = appointmentGivenBy;
    }

    public String getAppointmentGivenDate() {
        return appointmentGivenDate;
    }

    public void setAppointmentGivenDate(String appointmentGivenDate) {
        this.appointmentGivenDate = appointmentGivenDate;
    }
    ...
    public String getClientPatientContactNo() {
        return clientPatientContactNo;
    }

    public void setClientPatientContactNo(String clientPatientContactNo) {
        this.clientPatientContactNo = clientPatientContactNo;
    }

    public String getClientPatientEmail() {
        return clientPatientEmail;
    }

    public void setClientPatientEmail(String clientPatientEmail) {
        this.clientPatientEmail = clientPatientEmail;
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 89 * hash + Objects.hashCode(this.CON);
