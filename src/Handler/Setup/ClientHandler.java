...
public class ClientHandler implements java.io.Serializable {
    ...
    public boolean registerClient(Client client) {
        ...
        String[] columns = {Database.DCMS.client, "ID", "DESCRIPTION",
            ...
            "TRANSACTION_TYPE", "DISCOUNT", "CREDIT_LIMIT", "TEST_LIMIT",
        ...
        Constants.clientId = key.generatePrimaryKey(Keys.client, false);
        clientMap.put("ID", "'" + Constants.clientId + "'");
    ...
    public Client searchClientById(String clientId) {
        ...
        String[] columns = {Database.DCMS.client, "ID", "DESCRIPTION",
            ...
            "TEST_LIMIT", "CHECK_CREDIT", "ACCOUNT_ID"};
    ...
    public Vector selectClientLocations(String clientId) {

        String[] cols = {"", "CLIENT_ID", "LOCATION_DESCRIPTION"};
        String query
                = "SELECT CWL.CLIENT_ID , LOC.DESCRIPTION LOCATION_DESCRIPTION \n"
        ...
        for (int i = 0; i < vec.size(); i++) {
            ...
            client.setClientId(map.get("CLIENT_ID").toString());
    ...
    public boolean deleteClientLocation(String id) {
        String[] cols = {Database.DCMS.clientWiseLocation, "LOCATION_ID", "CLIENT_ID", "ID"};
    ...
    public boolean insertClientWisePackages(Vector vec) {
        String[] cols = {Database.DCMS.clientWisePackage,"CLIENT_ID", "PACKAGE_ID"};
        Vector inserts = new Vector();
