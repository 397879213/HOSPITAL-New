...
public class MachinePerformPlanTableModel extends AbstractTableModel {

    private String[] columnNames = {"Patient Id", "Sattus", "Plane Date",
        "Machine", "Body", "Days", "Time", "Select"};

    private Object[][] data;

    public MachinePerformPlanTableModel(List<PhysioMachine> lovs) {
