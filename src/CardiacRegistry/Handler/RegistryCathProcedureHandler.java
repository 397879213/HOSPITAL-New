...
public class RegistryCathProcedureHandler {
    ...
    public boolean insertCardiacSurgeryIntervention(CardiacRegistryCathProcedure insert) {
        ...
        String[] columns = {Database.DCMS.cardiacSurgeryIntervention, "ID",
            "CARDIAC_ID", "PROCEDURE_TYPE", "PROCEDURE_ID", "DATE_OF_PROCEDURE",
            "INSTITUTE_ID", "PERFORMING_PHYSICIAN_ID", "CRTD_BY", "CRTD_DATE",
            "CRTD_TERMINAL_ID"};
    ...
    public List<CardiacRegistryCathProcedure> selectCardiacSurgeryIntervention(
        ...
        String columns[] = {"-", "ID", "CARDIAC_ID", "PROCEDURE_TYPE", "PROCEDURE_ID",
            ...
            "PERFORMING_PHYSICIAN_ID", "PERFORMING_PHY_NAME", "CRTD_BY", "CRTD_DATE",
        ...
        String query
                ...
                + Database.DCMS.cardiacSurgeryIntervention + " CPD, \n"
    ...
    public boolean insertCardiacCathDetail(CardiacRegistryCathProcedure insert) {
    ...
    public boolean updateCardiacCathDetail(CardiacRegistryCathProcedure cardiac) {
        String query
                = " UPDATE " + Database.DCMS.cathCardiacDetail + "\n"
                + " SET EJECTION_FRACTION  = '" + cardiac.getEjectionFraction() + "',\n"
