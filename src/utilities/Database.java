...
public class Database {
    ...
    public static final class DCMS {
        ...
        public static final String medicineRequest = DAO.username + ".MEDICINE_REQUEST   ";
    ...
    public static class Inventory {
        ...
        public static final String itemCondemMaster = DAO.username + "." + "ITEM_CONDEM_MASTER ";
        public static final String itemCondemDetail = DAO.username + "." + "ITEM_CONDEM_DETAIL ";
        
        public static final String manualIndentMaster = DAO.username + "." + "MANUAL_INDENT_MASTER ";
        public static final String manualIndentDetail = DAO.username + "." + "MANUAL_INDENT_DETAIL ";
        public static final String pathCptWiseTubes = DAO.username + "." + "PATH_CPT_WISE_ITEM ";
        public static final String pathCptWiseTubesHis = DAO.username + "." + "PATH_CPT_WISE_ITEM_HISTORY ";
        public static final String cptWiseConsumableItems = DAO.username + "." + "CPT_WISE_CONSUMABLE_ITEMS ";
