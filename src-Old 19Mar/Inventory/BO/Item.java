...
public class Item {
    ...
    private String folicItemStock = "";
    private String folicItemDesc = "";
    private String quantity = "";
    private String storeId = "";

    public String getFolicItemStock() {
        return folicItemStock;
    }

    public void setFolicItemStock(String folicItemStock) {
        this.folicItemStock = folicItemStock;
    }

    public String getFolicItemDesc() {
        return folicItemDesc;
    }

    public void setFolicItemDesc(String folicItemDesc) {
        this.folicItemDesc = folicItemDesc;
    }
